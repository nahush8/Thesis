...
The thesis is organized in $5$ chapters following this chapter.\par
...
In chapter \ref{gpq}, we study the GP-Q algorithm along with the coverage of perception in the loop which is the foundation of the Multi-Fidelity Reinforcement Learning presented in the chapter following that.\par
Chapter \ref{gpMfrl} presents the idea of Multi-Fidelity Reinforcement Learning with Gaussian Processes which helps to reduce the number of real world samples using a simulator framework. Chapter \ref{bridge_chapter} discusses the practical application of the algorithms presented in the thesis along with some field experiments.\par 
We conclude the thesis with an overview of the main contributions and discussions about some future work. All the software corresponding to this thesis is available online on github. 
%-----------------------------------
%	SUBSECTION 2
%-----------------------------------
...
\begin{figure}[H]
	\centering
    \subfigure{\includegraphics[width=6cm]{env1.pdf}}
    \subfigure{\includegraphics[width=6cm]{env2.pdf}}
    \subfigure{\includegraphics[width=6cm]{env3.pdf}}
    \subfigure{\includegraphics[width=6cm]{env4.pdf}}
...
In order to compare the performance of the algorithms, we use \textit{reward} as a metric of comparison. The plot shown in figure \ref{fig:gpq_vs_q_reward} , shows the reward obtained over time for the naive $Q$ learning and the end to end GP-Q learning algorithm. An \textit{epoch} is defined to be a set of $200$ actions. After every epoch, the reward obtained by the agent is calculated. 

\begin{figure}[H]
	\centering
    \subfigure{\includegraphics[width=8cm]{r_env1.eps}}
    \subfigure{\includegraphics[width=8cm]{r_env2.eps}}
    \subfigure{\includegraphics[width=8cm]{r_env3.eps}}
    \subfigure{\includegraphics[width=8cm]{r_env3.eps}}
	\caption {Reward obtained over time}
