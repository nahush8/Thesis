...
We also present an implementation of GPQ algorithm \cite{chowdhary2014off} on different kinds of simulators. The feedback from the laser sensors is utilized by the learning algorithm in order to \textit{learn} a particular \textit{skill}.
