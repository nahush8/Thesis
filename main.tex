...
\begin{figure}[H]
	\centering
    \subfigure{\includegraphics[width=4cm]{env1.pdf}}
    \subfigure{\includegraphics[width=4cm]{env2.pdf}}
    \subfigure{\includegraphics[width=4cm]{env3.pdf}}
    \subfigure{\includegraphics[width=4cm]{env4.pdf}}
	\caption {Simulator Environments $1$ to $4$ from left to right}
   \label{fig:gpq_sim}
\end{figure}
...
\begin{figure}[H]
	\centering
    \subfigure{\includegraphics[width=5cm]{r_env1.eps}}
    \subfigure{\includegraphics[width=5cm]{r_env2.eps}}
    \subfigure{\includegraphics[width=5cm]{r_env3.eps}}
    \subfigure{\includegraphics[width=5cm]{r_env4_2.eps}}
	\caption {Reward obtained over time for environments $1$ to $4 given in figure \ref{fig:gpq_sim}$ respectively}
