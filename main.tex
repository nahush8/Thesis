...
\begin{figure}[H]
	\centering 
    \subfigure{\includegraphics[width=8cm]{uav-1.JPG}}
    \subfigure{\includegraphics[width=6cm]{quad.png}}
...
\begin{figure}[htp]
	\centering 
  	\subfigure{\includegraphics[width=6cm]{sr1.png}}
    \subfigure{\includegraphics[width=6cm]{sr2.png}}
    \subfigure{\includegraphics[width=6cm]{sr3.png}}
    \subfigure{\includegraphics[width=6cm]{sr4.png}}
...
\begin{figure}[htp]
	\centering 
  	\subfigure{\includegraphics[width=8cm,height=5cm]{cm1.jpg}}
    \subfigure{\includegraphics[width=8cm]{coleman2.png}}
...
\begin{figure}[htp]
	\centering 
  	\subfigure{\includegraphics[width=6cm]{bridge_img1.png}}
    \subfigure{\includegraphics[width=6cm]{bridge_img2.png}}
...
\begin{figure}[htp]
	\centering 
    \subfigure{\includegraphics[width=6cm,height=5cm]{3d1.png}}
    \subfigure{\includegraphics[width=8cm]{3d3.png}}
...
\SetKwInOut{Input}{Input}\SetKwInOut{Init}{Initialize}\SetKwInOut{local}{Local data}
\SetKwFunction{trainingPhase}{trainingPhase}\SetKwFunction{findMax}{findMax}\SetKwFunction{batchGPQ}{batchGPQ}\SetKwFunction{updateGP}{updateGP} \SetKwFunction{gpPredict}{gpPredict} \SetKwFunction{main}{main}
...
\SetKwProg{run}{}{}{}
\run{\main{}}{
	\While{\textit{termination condition not reached}}{
	$GP$ = \batchGPQ{}\\
    Choose action $a^* = \findMax(\texttt{GP},s')$\\
    Apply $a^*$ for a $\Delta t$ time\\
    observe reward $r$\\
    }
...
\SetKwProg{gpq}{}{}{}
\gpq{\batchGPQ{\texttt{GP}, T}}{
\Input{$T:= {(s,a,r,s')}$ is the new experience obtained during runtime}
$dX \leftarrow$ \texttt{input to the GP}\\
$tX \leftarrow$ \texttt{output of the GP}.\\
 \For{$i \in (1,N)$}{
 $dX \leftarrow dX \cup {(s_i,a_i)}$\\
...
\run{\main{}}{
    ...
    \Init{Gaussian Process \texttt{GP} with RBF kernel of appropriate length scale}
	\While{\textit{termination condition not reached}}{
	$GP$ = \batchGPQ{\texttt{GP}, T}\\
    $s \leftarrow$ current state \\
    Choose greedy action $a = \findMax(\texttt{GP},s')$ with probability $1 - \epsilon$\\
    A random action is chosen with a probability $\epsilon$\\
    Apply $a$ for a $\Delta t$ time\\
    $s' \leftarrow$ observed state\\
    $r \leftarrow $ observed reward\\
    $T \leftarrow T \cup \{(s,a,r,s')\}$\\
    \If{$r < .75$ $\times$ sum of rewards over time}
    {
    Update the GP using $GP$ = \batchGPQ{\texttt{GP}, T}\\
    }
    }
    
}
\caption{$\epsilon$ greedy online GPQ Algorithm}
\end{algorithm}
...
\begin{figure}
	\centering 
    \subfigure[Environment 1]{\includegraphics[width=8cm]{env1.pdf}}
    \subfigure[Environment 2]{\includegraphics[width=8cm]{env2.pdf}}
    \subfigure[Environment 3]{\includegraphics[width=8cm]{env3.pdf}}
    \subfigure[Environment 4]{\includegraphics[width=8cm]{env4.pdf}}
...
\begin{figure}[H]
	\centering
    \subfigure[Reward collected in Environment 1]{\includegraphics[width=10cm]{r_env1.eps}}
    \subfigure[Reward collected in Environment 2]{\includegraphics[width=10cm]{r_env2.eps}}
    \subfigure[Reward collected in Environment 3]{\includegraphics[width=10cm]{r_env3.eps}}
    \subfigure[Reward collected in Environment 4]{\includegraphics[width=10cm]{r_env4_main.eps}}
...
\begin{figure}[H]
	\centering   
	\subfigure[Gazebo environment 1]{\includegraphics[width=6cm]{corridor.pdf}}
    \subfigure[Reward collected in Gazebo environment 1]{\includegraphics[width=10cm]{gpq_q_epoch_20.eps}}
	
    \subfigure[Gazebo environment 2]{\includegraphics[width=6cm]{gazebo_env2.pdf}}
    \subfigure[Reward collected in Gazebo environment 2]{\includegraphics[width=10cm]{gpq_q_epoch_20_2.eps}}
