...
\begin{itemize}
\item \textbf{Camera}: The camera used to capture the visuals is \cite{fleacamera} as shown in figure \ref{fig:cam}. The resolution of the images is $1600 \times 1200$ and can capture images upto $59$ FPS.
\begin{figure}[H]
	\centering 
